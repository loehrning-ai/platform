...
export default {
  ...
  "month-grid": {
    ...
    revealOrder: ["The Werk Nord folder: 12 files", "Empty grid", "Room vote", "Grid as delivered, with the August dip", "The two March bills side by side, invoice numbers marked", "Meter rows and the October subtraction", "Net line: duplicate March, missing October, {wn_net_raw_vs_right_kwh} off"],
  ...
  anatomy: {
    ...
    revealOrder: ["Prediction band and the raw-folder bar; the right total is a question mark", "Room vote", "Duplicate and October bars, and the right total", "Talbrück and unit bars", "Gas and AdBlue bars, two cards", "Swing band; the title now gives the gap"],
