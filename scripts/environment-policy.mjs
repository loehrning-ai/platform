...
// Platform-issued runtime credentials are classified here so source scans can
// account for them without forwarding them into build, test, or provider-free
// child processes. Vercel injects OIDC into the deployed Node runtime.
export const RUNTIME_ONLY_PROVIDER_ENVIRONMENT_KEYS = Object.freeze([
  "VERCEL_OIDC_TOKEN",
]);
