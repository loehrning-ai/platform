...
| Name the route | "Claude, Chat A, no instructions, on this date." | "The same model got it wrong." | Say "same AI route". The files, instructions and settings are part of the route. |
