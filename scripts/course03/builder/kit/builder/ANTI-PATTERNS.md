...
- **Before you build:** read the group for the step you are on (see `RUNBOOK.md`).
...
| AP-E04 | An average across controls | "Four of five gates green: 80 % ready" | A weak control hides behind the average | The weakest control decides: not ready, pilot only, bounded ready | Review of READY-CANVAS | Build |
