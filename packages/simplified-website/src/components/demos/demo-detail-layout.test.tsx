...
describe("<DemoDetailLayout>", () => {
  ...
  it("surfaces the related book resolved from the demo's bookSlugs", () => {
    render(<DemoDetailLayout demo={excel} />);
    // excel.bookSlugs = ['ki-tools-selbststaendige'] -> book.readerHref.
    const hrefs = screen
      .getAllByRole("link")
      .map((l) => l.getAttribute("href"));
    expect(hrefs).toContain("/buecher/ki-tools-selbststaendige");
  });
