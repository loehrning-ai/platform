...
export function Footer() {
  // Derive the current year client-side to avoid an SSR/CSR hydration mismatch
  // when the server and client clocks straddle a year boundary. Falls back to
  // a fixed constant for the server-rendered HTML.
