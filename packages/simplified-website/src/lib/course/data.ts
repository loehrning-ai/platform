...
// The 41-term glossary was previously unimported dead data. It now has a
...
const EU_AI_ACT_KURS: CourseData = {
  ...
  blockMeta: {
    ...
    block_2: {
      ...
      description:
        "Verboten, hochriskant, begrenzt oder minimal: klassifizieren Sie KI-Systeme sicher.",
      durationMinutes: 16,
    },
    block_3: {
...
//
// The 41-term glossary is the single source: rather than copy card text into
