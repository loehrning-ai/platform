 ...
 * `serviceAddress` is null by explicit operator decision (2026-07-16): the
 * platform launches with email-first contact only. Never infer this value;
 * if a postal address is published later, insert it here and the legal pages
