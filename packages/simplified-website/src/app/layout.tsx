...
const loehrningSans = localFont({
  src: [
    { path: "../fonts/LoehrningSans-Regular.ttf", weight: "400", style: "normal" },
    { path: "../fonts/LoehrningSans-Medium.ttf", weight: "500", style: "normal" },
    { path: "../fonts/LoehrningSans-SemiBold.ttf", weight: "600", style: "normal" },
    { path: "../fonts/LoehrningSans-Bold.ttf", weight: "700", style: "normal" },
  ],
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "loehrning.ai",
    description:
      "Deutsche KI-Lernplattform: Kurse, Bücher, Demos und Vorlagen. Kostenlos, ohne Kontozwang.",
    images: ["/og-image.png"],
  },
  alternates: {
    canonical: "/",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="de"
      className={`${loehrningSans.variable} ${GeistSans.variable} ${GeistMono.variable}`}
    >
