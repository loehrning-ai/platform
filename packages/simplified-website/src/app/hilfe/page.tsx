...
function getFaqItems(accountEnabled: boolean, feedbackEnabled: boolean): readonly {
  ...
  },
  {
    ...
    answer: accountEnabled
      ? "Du brauchst kein Konto, um Kurse, Bücher, Demos oder Vorlagen zu nutzen. Alle Inhalte sind ohne Anmeldung zugänglich. Das aktivierte Lernkonto synchronisiert Fortschritt über mehrere Geräte und verwendet einen Einmal-Link per E-Mail. Die Daten liegen auf Servern in der EU."
      : "Du brauchst kein Konto. Kurse, Bücher, Demos, Vorlagen und Downloads sind ohne Anmeldung zugänglich. Das optionale Lernkonto und die geräteübergreifende Synchronisierung sind in dieser Version deaktiviert; Fortschritt bleibt lokal in diesem Browser.",
  },
  {
    id: "fortschritt-weg",
  ...
  },
  {
    ...
    answer:
      `Alle ${books.length} Bücher sind kostenlos im Browser lesbar. PDF-Downloads werden in dieser Version nicht angeboten. Die Bücher sind adaptierte Lernversionen der Originalmanuskripte; sie sind Lernmaterial, keine zitierfähigen Rechtsquellen.`,
  },
  {
    id: "konto-loeschen",
