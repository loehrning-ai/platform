...
export function KursContent({ blocks, totalLessons }: KursContentProps) {
  ...
  useEffect(() => {
    // Restore progress from URL hash if present (cross-device sharing)
        ...
        >
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              5 Blöcke, {totalLessons} Lektionen, 1 Teilnahmebestätigung. Kostenlos.
            </p>
              ...
              <button
                ...
                onClick={() => {
                  const url = buildProgressUrl(
                    COURSE_SLUG,
                    `${window.location.origin}/ki-fuehrerschein/kurs`,
                  );
                  if (url) {
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <Link
                        href={`/ki-fuehrerschein/kurs/${block.id}`}
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      20 Praxisfragen &middot; 70% zum Bestehen &middot; 25 Minuten
                    </p>
                  </div>
                </div>
                {allLessonsDone && !progress.quizPassed ? (
                  <Link
                    href="/ki-fuehrerschein/kurs/quiz"
                  ...
                  <Link
                    href="/ki-fuehrerschein/kurs/zertifikat"
