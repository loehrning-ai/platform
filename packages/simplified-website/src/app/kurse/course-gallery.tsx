  ...
  return (
    <div className="space-y-16">
                ...
                <Card accent="kupfer" className="h-full">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      {/* Numbered step — makes the path explicit */}
                      <span
                        aria-hidden="true"
                        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand-orange font-mono text-[15px] font-bold text-white"
                      >
                        {course.step}
                      </span>
                      <IconTile icon={Icon} accent="kupfer" />
                    </div>
                    {hydrated && stat.certified && (
                      <span
                        data-testid={`certified-${course.slug}`}
                        className="inline-flex items-center gap-1 rounded-full bg-kupfer-mist px-2.5 py-1 font-mono text-[10px] font-bold uppercase tracking-[0.1em] text-brand-orange"
                      >
      ...
      <section id="tiefer-gehen" className="scroll-mt-24">
        ...
        {/* Sub-shelf: Angewandte Kurse (applied, live-built) */}
        <div className="mt-14">
          <SubHeader>
