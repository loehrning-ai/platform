...
// Block meta durations sourced from src/lib/course/data.ts blockMeta
// block_1: 14 min, block_2: 16 min, block_3: 18 min, block_4: 16 min, block_5: 14 min, block_6: 18 min
// Sum: 96 min = ca. 1,5 Stunden (PT1H30M)
const blocks = [
  {
    n: "Block 01",
    title: "Der EU AI Act im Überblick",
    minutes: 14,
    desc: "Warum es das Gesetz gibt, welche Rollen es unterscheidet und wann welche Pflichten greifen. Für alle.",
    track: "alle",
  },
  {
    n: "Block 02",
    title: "Verbote, Risiken und deine Rechte",
    minutes: 16,
    desc: "Was verboten ist (Art. 5), wie Risikostufen funktionieren und was du als Nutzerin oder Nutzer wissen darfst. Für alle.",
    track: "alle",
  },
  {
    n: "Block 03",
    title: "Pflichten für Hochrisiko-KI",
    minutes: 18,
    desc: "Risikomanagement, Datengovernance, Logging, menschliche Aufsicht nach Art. 8-15. Für Personen mit beruflicher Verantwortung.",
    track: "beruf",
  },
  {
    n: "Block 04",
    title: "GPAI und Foundation Models",
    minutes: 16,
    desc: "OpenAI, Anthropic, Mistral. Welche Pflichten entstehen beim Einsatz großer Sprachmodelle. Für Personen mit beruflicher Verantwortung.",
    track: "beruf",
  },
  {
    n: "Block 05",
    title: "Aufsicht, Bußgelder und Zeitplan",
    minutes: 14,
    desc: "Wer kontrolliert, welche Regeln am 2. August 2026 greifen und warum Hochrisiko einem späteren Zeitplan folgt. Für Personen mit beruflicher Verantwortung.",
    track: "beruf",
  },
  {
    n: "Block 06",
    title: "Governance, Vorlagen und Quiz",
    minutes: 18,
    desc: "Acht Arbeitsvorlagen für den Einstieg in KI-Governance. Abschluss-Quiz mit lokaler Teilnahmebestätigung. Für Personen mit beruflicher Verantwortung.",
    track: "beruf",
  },
] as const;
...
export default function EuAiActKursLandingPage() {
  return (
    <>
      ...
      <div className="mx-auto max-w-[1180px] px-6 pb-32 pt-20">
        ...
        <section className="mt-10 border-2 border-foreground bg-card p-8 shadow-[6px_6px_0_var(--color-foreground)] sm:p-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.55] text-muted-foreground">
                Hochrisiko-Pflichten, GPAI, Governance und Vorlagen, für Personen,
        ...
        <section className="mt-24">
          ...
          <div className="mt-6 font-mono text-[12px] text-muted-foreground">
            6 Lernblöcke · je 14–18 Minuten · gesamt ca. 1,5 Stunden
          </div>
        </section>
