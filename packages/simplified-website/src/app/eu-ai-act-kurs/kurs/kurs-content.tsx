      ...
      <div className="mx-auto max-w-5xl px-6 pt-12 pb-16">
        ...
        >
          ...
          <div className="border border-border/50 bg-card/30 px-5 py-4 text-xs leading-relaxed text-muted-foreground">
            ...
            Dieser Kurs vermittelt Wissen über die EU-KI-Verordnung (VO (EU) 2024/1689). Er ersetzt keine Rechtsberatung. Für konkrete Compliance-Fragen wende dich an eine Rechtsanwältin oder einen Compliance-Beauftragten. Rechtsstand der zeitabhängigen Angaben: 14. Juli 2026.
          </div>
