...
const SUPPORT_TILES = [
  ...
  },
  {
    ...
    body: "Vorlagen für Richtlinien und Risikoeinschätzung.",
    href: "/vorlagen",
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        {nextCourse ? (
          ...
          <Card accent="kupfer" className="mt-6 bg-kupfer-mist">
            ...
            <p className="mt-2 text-[20px] font-bold tracking-[-0.02em] text-foreground">
              Alle Kurse abgeschlossen. Vertiefe dein Wissen mit den Arbeitsvorlagen.
            </p>
            <div className="mt-5">
              <BrandButton href="/vorlagen" variant="outline" size="sm">
                Zu den Vorlagen <ArrowRight size={15} aria-hidden="true" />
              </BrandButton>
            </div>
          </Card>
        )}
