...
Öffentlich zugänglich sind Startseite, Kurse, Kursreader, Bücher, Demos, Vorlagen, Blog, offene Labs, Rechtliches und maschinenlesbare Metadaten. Einige öffentliche Lern- und Utility-Seiten werden nicht in der Sitemap gelistet, bleiben aber crawlbar, damit Noindex- oder Kontextsignale gelesen werden können.

## Private Zustände

Wenn die optionale Kontofunktion vollständig konfiguriert ist, kann sie Fortschritt, Zertifikatsstatus, Datenschutzaktionen und serverseitige Synchronisation speichern. Ohne diese Providerkonfiguration bleiben Lerninhalte öffentlich und Fortschritt lokal im Browser. Private Zustands-APIs, Kontoseiten, Feedbackmoderation, Providerkonfiguration und Betriebsnachweise sind nicht Teil dieser Datei. Vorlagen-Downloads sind öffentlich und absichtlich nicht indexierbar.
