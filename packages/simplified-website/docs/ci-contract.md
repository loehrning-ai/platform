...
| Environment contract        | `bun run --cwd packages/simplified-website test:env-contract` | Proves that partial, insecure, or unattested optional-provider configuration fails gated builds.                                                                                                                                                                                                 |
...
`bun run --cwd packages/simplified-website test:e2e:dev` command is development
