...
The deck always replays embedded historical observations. The lab is a deterministic browser simulation. The builder kit is a starting point, not a certified configuration. None of them establishes present-day model reliability, permissions or production readiness.
