...
You need a Claude account. Projects are on every plan, free included (up to five on free). They make step 3 easier, but they are optional.
...
are short by exactly 258,785 in every month. In rehearsal, Project B's answer came with its source, its version and the age of the data. Neither
...
| Name the route | "Claude, Chat A, no instructions, <run date>." | "Claude got it wrong." (no route) | Say "same AI route". The files, instructions and settings are part of what you tested. |
