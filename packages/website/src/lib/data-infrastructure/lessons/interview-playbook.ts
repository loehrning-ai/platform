...
export const INTERVIEW_MOVES: readonly InterviewMoveItem[] = [
  ...
  },
  {
    ...
    note: "Adding brokers relocates a hot partition. It does not divide that partition's records.",
  },
  {
    tag: "tradeoff",
