...
describe("data-science chapter-component loader map (plan 012 stages 1, 6, 7, 8, 9)", () => {
  it("resolves a real component for every populated id (fund, eval — stage 6; home, explore, clean — stage 7; feature, model — stage 8; interp, exp — stage 9)", async () => {
