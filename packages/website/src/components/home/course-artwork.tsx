  ...
  return (
    ...
    >
      ...
      <Image
        ...
        sizes={
          wide
            ? "(max-width: 639px) 72px, (min-width: 1280px) 606px, (min-width: 1024px) 54vw, (min-width: 768px) calc(50vw - 60px), calc(100vw - 48px)"
            : "(max-width: 639px) 72px, (min-width: 1280px) 426px, (min-width: 1024px) 38vw, (min-width: 768px) calc(50vw - 60px), calc(100vw - 48px)"
        }
