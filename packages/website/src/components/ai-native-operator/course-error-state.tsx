      ...
      <div className="w-full max-w-lg min-w-0 border-2 border-foreground bg-card p-6 shadow-[6px_6px_0_var(--color-foreground)] sm:p-8">
        ...
        <div className="mt-7 flex min-w-0 flex-col items-start gap-4 sm:flex-row sm:items-center">
          <button
            type="button"
            onClick={reset}
            className="inline-flex min-h-11 max-w-full items-center gap-2 break-words border-2 border-foreground bg-brand-orange px-5 py-3 text-left font-mono text-xs font-bold uppercase tracking-wide text-white shadow-[4px_4px_0_var(--color-foreground)] [overflow-wrap:anywhere] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground"
          >
