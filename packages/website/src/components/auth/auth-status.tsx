...
export function AuthStatus({
  ...
  return (
    <Link
      ...
      onClick={onNavigate}
      className={cn(
        "inline-flex min-h-11 min-w-[6.75rem] items-center justify-center gap-2 rounded-xl border border-brand-cobalt bg-brand-cobalt px-3 py-2 font-ui-mono text-xs font-bold uppercase tracking-[0.08em] text-white shadow-[3px_3px_0_var(--color-brand-acid)] outline-none transition-[background-color,border-color,color,transform] duration-150 hover:-translate-y-0.5 hover:border-brand-teal hover:bg-brand-teal focus-visible:ring-2 focus-visible:ring-brand-cobalt focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transform-none motion-reduce:transition-none",
