          ...
          <div className="flex flex-col gap-2">
            {remaining.map((block) => (
              <button
                ...
                className="min-h-11 min-w-0 break-words border-2 border-border bg-background px-3 py-2 text-left font-mono text-[12.5px] text-foreground transition-colors hover:border-brand-orange"
              >
