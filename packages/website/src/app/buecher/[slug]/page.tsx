...
// The catalog is a fixed, curated list, not user-generated slugs — a slug
// outside generateStaticParams (including books pending re-review, see
// @/lib/books) must hard-404 instead of falling through to a dynamically
// rendered notFound() page, which some hosts cache/serve with status 200.
