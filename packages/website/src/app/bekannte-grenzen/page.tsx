...
function getLimitations(accountEnabled: boolean): readonly Limitation[] {
  ...
  },
  {
    ...
    description:
      books.length === 1
        ? "Das verfügbare Buch ist eine adaptierte Lernversion. Es ist keine zitierfähige Rechtsquelle, kein offizielles Behördendokument und kein Ersatz für Rechtsberatung."
