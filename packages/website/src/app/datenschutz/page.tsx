          ...
          <LegalSection title="4. Kontaktaufnahme und Feedback">
            ...
            {features.feedback ? (
              <p className="mt-2">
                ...
                SHA-256-Hash der an der Hosting-Ebene als vertrauenswürdig
          ...
          >
            {features.anthropic ? (
              <>
                ...
                <p className="mt-2">
                  Zur Missbrauchsbegrenzung wird ein SHA-256-Hash der an der
                  Hosting-Ebene als vertrauenswürdig übergebenen Client-IP als
