...
export const metadata: Metadata = {
  title: "Claude Course: Lessons",
  description:
    "Twelve hands-on lessons on prompting Claude effectively, across four tracks: Foundations, Workflows, Going deeper, Team and rigor.",
  robots: { index: false, follow: true },
  alternates: { canonical: `${SITE_URL}/kurse/open-source/claude/kurs` },
};
  ...
  return (
    <div className="mx-auto max-w-[900px] px-6 py-16">
      ...
      <p className="mt-3 max-w-[600px] text-[16px] leading-[1.5] text-muted-foreground">
        Start with the mental model. End with a team that ships better work, faster. Everything in
        between is practice.
      </p>

      <div className="mt-10 flex flex-col gap-10">
        {CLAUDE_TRACKS.map((track, trackIndex) => {
