  ...
  const copy =
    locale === "en"
      ? {
          ...
          body: "The course content did not load. Retry the request.",
          retry: "Try again",
          back: "Back to course",
        }
      : {
          ...
          body: "Der Kursinhalt wurde nicht geladen. Versuche die Anfrage erneut.",
          retry: "Erneut versuchen",
          back: "Zurück zum Kurs",
        };
  useEffect(() => {
    reportClientBoundaryError("ki-und-gesellschaft-course", error);
  }, [error]);
