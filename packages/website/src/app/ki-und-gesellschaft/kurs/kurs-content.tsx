...
const COURSE_HUB_COPY: Readonly<Record<Locale, CourseHubCopy>> = {
  de: {
    ...
    noticeLabel: "Quellen und Grenzen",
    notice:
  ...
  en: {
    ...
    noticeLabel: "Sources and limits",
    notice:
      "The course examines published research and documented cases. Sources and review dates appear in the lessons. It is not legal, career, or case-specific advice.",
  ...
  async function shareProgress(): Promise<void> {
    ...
    try {
      const url = buildProgressUrl(
        COURSE_SLUG,
        `${window.location.origin}${localizeHref("/ki-und-gesellschaft/kurs", locale)}`,
      );
      if (!url) return;
            ...
            {progress.completedLessons > 0 && (
              <>
                <button
                  ...
                  aria-describedby={
                    shareState === "error"
                      ? "ki-gesellschaft-progress-share-error"
                      : undefined
                  }
                ...
                {shareState === "error" && (
                  <p
                    id="ki-gesellschaft-progress-share-error"
                    role="alert"
                ...
                >
                  <div className="min-w-0 p-4 sm:p-6">
                    ...
                    <div className="mt-4 flex min-w-0 flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <Link
                        href={localizeHref(
                          `/ki-und-gesellschaft/kurs/${block.id}`,
                          locale,
                        )}
