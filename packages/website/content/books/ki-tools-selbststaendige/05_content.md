...
>
> ```
> Kontext: Ich bin [BERUF] in [BRANCHE]. Meine Zielgruppe:
> [ZIELGRUPPE]. Meine Content-Kanäle: [KANÄLE, z.B. LinkedIn,
> Blog, Newsletter]. Posting-Frequenz: [FREQUENZ, z.B. 3x/Woche
> LinkedIn, 1x/Woche Blog].
> Rolle: Du bist ein Content-Strategieberater für B2B-Selbstständige.
> Aufgabe: Erstelle einen 3-Monats-Redaktionsplan.
> Themen müssen [ZIELGRUPPE] ansprechen und meine Expertise in
> [KERNTHEMA] zeigen.
> Format: Tabelle mit Spalten: KW, Thema, Format (Blog/LinkedIn/
> Newsletter), Kernbotschaft, CTA.
...
|---------|-----|-------------|------|
| 1 | Keyword-Recherche | KI + du | 5 Min. |
| 2 | Outline erstellen | KI | 3 Min. |
| 3 | Outline prüfen/anpassen | Du | 5 Min. |
| 4 | Erster Entwurf | KI | 5 Min. |
| 5 | Entwurf überarbeiten | Du | 15 Min. |
| 6 | SEO-Feinschliff | KI + du | 5 Min. |
...
>
> ```
> Kontext: Ich bin [BERUF] und schreibe einen Blogartikel über
> [THEMA]. Zielgruppe: [ZIELGRUPPE]. Keyword: [KEYWORD].
> Rolle: Du bist ein SEO-erfahrener Content-Writer für den
> deutschen Markt.
> Aufgabe: Erstelle einen Blogartikel. Packende Einleitung
> (kein "In der heutigen Zeit"). 3-5 Hauptabschnitte mit
> Unterüberschriften. Praktische Tipps. Schlussfazit mit CTA.
> Format: 800-1.200 Wörter. H2 und H3 Überschriften.
> Keyword [KEYWORD] natürlich einbauen (3-5x).
...
8. **Das Vorher/Nachher:** "Vorher: 3 Stunden. Nachher: 20 Minuten."
9. **Die Empfehlung:** Toolempfehlungen. Kurz.
10. **Die Geschichte:** "Vor zwei Jahren hat ein Kunde mich gefragt..."
...
>
> ```
> Kontext: Ich schreibe einen wöchentlichen Newsletter für
> [ZIELGRUPPE]. Hier sind meine 3 LinkedIn-Posts dieser Woche:
> [POST 1]
> [POST 2]
> [POST 3]
> Rolle: Du bist ein Newsletter-Experte für B2B.
> Aufgabe: Erstelle einen Newsletter. Persönliche Einleitung
> (2-3 Sätze), die 3 Posts als Themenblöcke (gekürzt, mit
> Link zum Original), ein abschließender Gedanke mit CTA.
> Format: Max. 500 Wörter. Betreffzeile, die zum Öffnen verleitet.
> Ton: Wie eine persönliche E-Mail an einen guten Bekannten.
...
```
Kontext: Ich bin [BERUF] in [STADT]. Meine Dienstleistung: [DIENSTLEISTUNG].
Rolle: Du bist ein SEO-Experte für den deutschen Markt.
Aufgabe: Recherchiere 20 Keywords, nach denen meine potenziellen Kunden
suchen könnten. Sortiere nach: Informational (Wissensfragen),
Transactional (Kaufabsicht), Local (Stadt/Region).
Format: Tabelle mit Spalten: Keyword, Typ, geschätztes Suchvolumen
(hoch/mittel/niedrig), Schwierigkeit, Content-Idee.
Ton: Datengetrieben, praxisnah.
```
...
> ```
> Kontext: Ich bin [BERUF] und poste auf LinkedIn über [THEMEN].
> Meine Zielgruppe sind [ZIELGRUPPE] in Deutschland.
> Rolle: Du bist ein Content-Stratege für B2B-Freelancer.
> Aufgabe: Erstelle einen 4-Wochen-Redaktionsplan mit 3 LinkedIn-
> Posts pro Woche, 1 Blogartikel pro Woche und 1 monatlichem
> Newsletter. Variiere die Post-Formate: Learning, Kontrast,
> Zahlen, Frage, Scheitern, Framework, Meinung, Vorher/Nachher,
> Empfehlung, Story.
> Format: Tabelle: Woche | Tag | Kanal | Format | Thema |
> Hook (erste Zeile)
