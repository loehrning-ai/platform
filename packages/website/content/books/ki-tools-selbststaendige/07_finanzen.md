...
> Projekt: [PROJEKTBESCHREIBUNG]. Budget: ca. [BETRAG] EUR.
> Kundengespräch-Notizen: [NOTIZEN, Stichworte reichen]
> Rolle: Du bist ein erfahrener Angebotsschreiber für Freelancer.
> Aufgabe: Formuliere ein professionelles Angebot mit:
> 1. Einleitung (Bezug aufs Gespräch, Problemverständnis)
> 2. Leistungsbeschreibung (nummerierte Positionen)
> 3. Zeitrahmen und Meilensteine
> 4. Preis (netto + USt-Hinweis)
> 5. Gültigkeit und nächste Schritte
> Format: Max. 1 Seite. Professionell formatiert.
...
Der Kunde zögert beim Preis.
Rolle: Du bist ein Pricing-Stratege für Freelancer.
Aufgabe: Formuliere 3 Argumente, warum der Preis gerechtfertigt ist.
Fokus auf konkreten Gewinn (was der Kunde davon hat), nicht auf Aufwand
...
"Konzeption, Design und Entwicklung einer responsiven Unternehmenswebsite inkl. SEO-Optimierung, Content-Management-System, Kontaktformular und Einweisung (8 Seiten, nach Briefing vom [DATUM])" → der Kunde sieht den Wert.

```
Kontext: Ich habe für [KUNDE] folgende Leistung erbracht:
[STICHWORTE]. Rechnungsbetrag: [BETRAG] EUR netto.
Rolle: Du bist ein Experte für professionelle Rechnungstexte.
Aufgabe: Formuliere eine Leistungsbeschreibung für meine Rechnung.
Die Beschreibung muss den Umfang und Wert der Arbeit widerspiegeln.
Format: 3-5 Zeilen. Professionell, detailliert, nicht aufgebläht.
...
>
> ```
> Kontext: Mein Kunde [ANONYMISIERT] hat Rechnung [NR] über
> [BETRAG] EUR seit [TAGE] Tagen nicht bezahlt.
> Zahlungsziel war [DATUM]. Es ist die [ERSTE/ZWEITE/DRITTE]
> Erinnerung.
> Rolle: Du bist ein Experte für professionelle Geschäfts-
> kommunikation.
> Aufgabe: Schreibe eine Zahlungserinnerung.
> [ERSTE: freundlich] [ZWEITE: bestimmt] [DRITTE: letzte Frist
> mit Hinweis auf weitere Schritte].
> Format: E-Mail mit Betreffzeile. Max. 100 Wörter.
> Rechnungsdaten referenzieren.
...
> **Eingabe:** ChatGPT Plus 23 EUR, neuer Laptop 1.499 EUR, Mittagessen mit Kunde 48 EUR, Handyvertrag 39 EUR, Netflix 13 EUR, Bahnticket zum Kundentermin 67 EUR
>
> **Ausgabe:**
>
> | Posten | Betrag | Kategorie | Hinweis |
> |---|---|---|---|
> | ChatGPT Plus | 23 EUR | Betriebsausgabe | Voll absetzbar |
> | Laptop | 1.499 EUR | Betriebsausgabe | Über 800 EUR netto: über Nutzungsdauer abschreiben |
> | Mittagessen mit Kunde | 48 EUR | Betriebsausgabe | Bewirtung, 70 Prozent absetzbar, Beleg + Anlass notieren |
> | Handyvertrag | 39 EUR | Gemischte Nutzung | Beruflichen Anteil schätzen |
...
Q[1/2/3/4] 2026 vor. Einnahmen: [BETRAG]. Ausgaben: [BETRAG].
Besondere Posten: [Z.B. neue Hardware, Geschäftsreise, Fortbildung].
Rolle: Du bist ein Assistent für Steuervorbereitung
(KEINE Steuerberatung).
Aufgabe: Erstelle eine Checkliste: Welche Belege brauche ich?
Welche Fristen gelten? Welche Posten sollte ich meinem
Steuerberater besonders erklären?
Format: Checkliste mit Kategorien. Max. 300 Wörter.
...
| Was | Wann | Für wen |
|-----|------|---------|
| E-Rechnungen empfangen | Ab 01.01.2025 | Alle B2B in Deutschland |
| E-Rechnungen versenden | Ab 01.01.2027 | Unternehmen > 800.000 EUR Umsatz |
| E-Rechnungen versenden | Ab 01.01.2028 | Alle B2B |
