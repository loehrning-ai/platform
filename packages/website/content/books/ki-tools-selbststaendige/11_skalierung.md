...
| Vorher (Stundensatz) | Nachher (Produkt) | KI-Rolle |
|----------------------|-------------------|----------|
| "Ich berate dich individuell" | "KI-Readiness-Check: 2h Analyse + Bericht" | Analyse-Framework, Bericht-Entwurf |
| "Ich schreibe deine Website-Texte" | "Website-Text-Paket: 5 Seiten, 1 Woche" | Erste Entwürfe aller 5 Seiten |
| "Ich gebe dir Fitness-Coaching" | "12-Wochen-Programm mit wöchentlichen Check-Ins" | Trainingsplan-Erstellung, Follow-Up-Mails |
| "Ich baue dir eine App" | "MVP-Paket: Konzept + Prototyp in 4 Wochen" | Spec-Erstellung, Code-Generierung |
...
- Ohne KI: 3 Tage Analyse + 2 Tage Bericht = 5 Tage = 6.000 EUR
- Mit KI: 2 Tage Analyse + 0,5 Tage Bericht = 2,5 Tage = 3.000 EUR
- Als Pauschalpreis: "KI-Readiness-Check: 5.000 EUR", Kunde zahlt weniger als vorher, du verdienst 2.000 EUR/Tag statt 1.200

**Beispiel 2: Grafikdesignerin, Stundensatz 85 EUR**
- Projekt: Website-Texte + Design für 5 Seiten
- Ohne KI: 40 Stunden = 3.400 EUR
- Mit KI: 20 Stunden = 1.700 EUR (aber gleiche Qualität)
- Als Pauschalpreis: "Website-Paket: 2.800 EUR", effektiver Stundensatz: 140 EUR

**Beispiel 3: Business-Coach, Stundensatz 150 EUR**
- Produkt: "12-Wochen-Programm mit KI-gestützten Check-Ins"
- Ohne KI: 24 Stunden Coaching + 12 Stunden Vorbereitung = 36h = 5.400 EUR
- Mit KI: 24 Stunden Coaching + 4 Stunden Vorbereitung = 28h
- Als Pauschalpreis: "4.500 EUR", und du hast 8 Stunden gewonnen
...
>
> ```
> Kontext: Ich bin [BERUF] und verkaufe aktuell [DIENSTLEISTUNG]
> auf Stundenbasis. Stundensatz: [BETRAG] EUR. Typischer
> Projektumfang: [BESCHREIBUNG].
> Rolle: Du bist ein Business-Stratege für Freelancer.
> Aufgabe: Entwickle 3 Ideen, wie ich meine Dienstleistung als
> Paket/Produkt anbieten kann. Für jede Idee: Name, Umfang,
> Preis, Lieferzeit, welche Teile KI übernehmen kann.
> Format: 3 Vorschläge, je max. 100 Wörter.
> Ton: Strategisch, konkret, realistisch.
> ```
...
| Rolle | KI-Lösung | Kosten/Monat |
|-------|-----------|-------------|
| Texter/in | ChatGPT / Claude | 20-40 EUR |
| Researcher | Perplexity | 20 EUR |
| Social-Media-Manager/in | KI + Scheduling-Tool | 20-30 EUR |
| Projektassistent/in | KI + Notion/Asana | 10-20 EUR |
...
**Strategie 1: Mehr Kunden, gleicher Aufwand.**
...
Rolle: Du bist ein Produktstratege für digitale Produkte.
Aufgabe: Entwickle 3 Ideen für digitale Produkte (Templates,
Online-Kurse, Toolkits), die ich aus meiner Expertise erstellen
und verkaufen kann. Für jede Idee: Name, Zielgruppe, Preis,
Aufwand für Erstellung, Verkaufskanal.
Format: 3 Vorschläge, strukturiert.
...
>
> **Schritt 3:** Rechne den effektiven Stundensatz für jedes Paket aus: Paketpreis geteilt durch geschätzte Stunden. Welches Paket verdoppelt deinen Stundensatz? (5 Min.)
>
> **Schritt 4:** Wähle das Paket mit dem besten Stundensatz. Schreibe ein konkretes Angebot für einen Bestandskunden, mit Paketname, Leistungsbeschreibung und Festpreis. Nutze die Angebotsstruktur aus Kapitel 7. (12 Min.)
>
> **KRAFT-Prompt:**
> ```
> Kontext: Ich bin [BERUF] mit einem Stundensatz von [X] EUR.
> Meine häufigsten Aufträge: [AUFTRAGSTYP 1], [AUFTRAGSTYP 2],
> [AUFTRAGSTYP 3]. Ich möchte vom Stundensatz auf Paketpreise
> umstellen.
> Rolle: Du bist ein Pricing-Berater für Freelancer und
> Solopreneure.
> Aufgabe: Erstelle 3 Paketangebote in den Stufen Basic,
> Professional und Premium. Für jedes Paket: Name, Beschreibung
> (3 Sätze), Leistungsumfang, Preis, geschätzter Zeitaufwand
> für mich.
> Format: 3 Pakete als übersichtliche Blöcke. Am Ende: Tabelle
> mit Paket | Preis | Geschätzte Stunden | Effektiver Stundensatz.
