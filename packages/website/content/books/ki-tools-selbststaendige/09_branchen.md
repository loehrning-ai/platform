...
```
Kontext: Ich bin [BERATER/COACH] und plane einen Workshop zum Thema
[THEMA] für [ZIELGRUPPE]. Dauer: [STUNDEN]. Teilnehmer: [ANZAHL].
Rolle: Du bist ein erfahrener Workshop-Designer.
Aufgabe: Erstelle ein Workshop-Konzept mit Zeitplan, Methoden,
Materialien und erwarteten Ergebnissen pro Block.
Format: Tabellarischer Zeitplan + 1 Absatz pro Block.
Ton: Professionell, didaktisch durchdacht.
```

**2. Konzept/Strategiepapier**

```
Kontext: Mein Kunde [ANONYMISIERT] hat folgendes Problem: [PROBLEM].
Branche: [BRANCHE]. Unternehmensgröße: [GRÖSSE].
Rolle: Du bist ein Strategieberater mit [BRANCHE]-Expertise.
Aufgabe: Erstelle ein Strategiekonzept. Analyse, 3 Handlungsoptionen
mit Vor-/Nachteilen, Empfehlung mit Begründung, nächste Schritte.
Format: Max. 5 Seiten. Executive Summary + Detail.
Ton: Professionell, klar, entscheidungsorientiert.
```

**3. Klienten-Follow-Up**

Nach jedem Termin: Entwurf für Zusammenfassung, Action Items und nächsten Termin. Erfasse die Zeit einschließlich Prüfung gegen die tatsächlichen Vereinbarungen.
...
bei der IHK [STADT] zum Thema [THEMA]. Publikum: 20-40
Geschäftsführer aus dem Mittelstand.
Rolle: Du bist ein erfahrener Keynote-Coach.
Aufgabe: Erstelle eine Vortragsstruktur mit 3 Kernbotschaften,
einem aktivierenden Einstieg, 2 Praxisbeispielen und einem
CTA am Ende (kostenloses Erstgespräch).
Format: Slide-by-Slide-Gliederung mit Sprechernotizen.
...
Rolle: Du bist ein Creative Director.
Aufgabe: Analysiere das Briefing. Welche Informationen fehlen?
Erstelle 10 Rückfragen, die ich dem Kunden stellen sollte,
um ein besseres Ergebnis zu liefern.
Format: Nummerierte Liste. Pro Frage: Warum sie wichtig ist.
...
[PROJEKT, z.B. Portfolio-Website meines Kunden].
Rolle: Du bist ein Copywriter für kreative Branchen.
Aufgabe: Schreibe [TEXTART, z.B. 5 Projektbeschreibungen
für ein Architektur-Portfolio].
Format: Je 50-80 Wörter. Emotional, nicht technisch.
...
Projekt abgeschlossen: [PROJEKTBESCHREIBUNG].
Rolle: Du bist ein Social-Media-Manager für Kreative.
Aufgabe: Schreibe einen Instagram-Post und einen LinkedIn-Post
über dieses Projekt. Der Instagram-Post ist visuell fokussiert.
Der LinkedIn-Post erzählt die Geschichte hinter dem Projekt.
Format: Instagram: max. 150 Wörter + 5 Hashtags.
LinkedIn: max. 200 Wörter + Hook in der ersten Zeile.
...
aufgetreten ist. Technische Ursache: [ERKLÄRUNG].
Rolle: Du bist ein IT-Projektmanager mit Kundenkontakt.
Aufgabe: Erkläre das Problem und die Lösung in Kundensprache.
Kein Jargon. Keine Schuldzuweisung.
Format: E-Mail, max. 150 Wörter.
Ton: Professionell, lösungsorientiert, beruhigend.
```
...
implementiert. Hier ist der Code / die Architektur: [BESCHREIBUNG].
Rolle: Du bist ein Technical Writer.
Aufgabe: Erstelle eine Dokumentation für [ZIELGRUPPE, Entwickler /
Projektmanager / Endnutzer].
Format: README-Stil mit Überschriften, Code-Beispielen, Diagramm-
beschreibungen.
Ton: Technisch präzise, aber verständlich für [ZIELGRUPPE].
```
...
Warum das für IT-Freelancer relevant ist: Standardisierte Tool-Schnittstellen können Integrationsarbeit reduzieren. Ob ein Kunde MCP braucht, hängt von Systemlandschaft, Berechtigungsmodell und Bedrohungsanalyse ab. Lerne das Protokoll, aber verkaufe keinen Server ohne konkreten Anwendungsfall und Sicherheitsgrenze.
...
Blinder Verlass auf KI-generierten Code ist gefährlich. KI-Code kann plausible Sicherheits- und Logikfehler enthalten. Lege risikobasierte Reviews, Tests, Dependency-Prüfungen und Freigaben fest; kritische Änderungen brauchen menschliche Verantwortung.
...
(Eiche massiv, 2,40 m x 3,20 m, Schiebetüren mit Softclose)
beim Kunden montiert. Hier sind meine Stichworte zur Dokumentation:
[STICHWORTE, z.B. Untergrund geprüft, Wasserwaage, Fugen
versiegelt, Einweisung Kunde, Abnahme ohne Mängel].
Rolle: Du bist ein technischer Redakteur für Handwerksbetriebe.
Aufgabe: Erstelle eine Baustellen-Dokumentation. Projektdaten,
durchgeführte Arbeiten, verwendetes Material, Abnahmeprotokoll.
Format: 1 Seite. Nummerierte Abschnitte. Platz für Unterschrift
Auftraggeber und Auftragnehmer unten.
Ton: Sachlich, fachlich korrekt, keine Werbung.
```

Ob der Ablauf Zeit spart, zeigt ein Vergleich aus Dokumentation, Prüfung und Korrektur. Der Entwurf darf keine nicht belegten Arbeiten oder Abnahmen ergänzen.
...
Einfamilienhaus Neubau. Hier sind meine Plan-Zahlen und Ist-Zahlen:
Plan: Material 2.100 EUR, Arbeitszeit 16h à 65 EUR, 3 Anfahrten à 45 EUR.
Ist: Material 2.640 EUR, Arbeitszeit 22h à 65 EUR, 5 Anfahrten à 45 EUR.
Angebotssumme: 4.800 EUR netto.
Rolle: Du bist ein Betriebswirt im Handwerk.
Aufgabe: Erstelle eine Nachkalkulation. Vergleiche Plan und Ist.
Berechne die Abweichung pro Position in Euro und Prozent.
Zeige den tatsächlichen Stundenlohn. Gib 3 konkrete Empfehlungen,
wie ich beim nächsten vergleichbaren Auftrag besser kalkuliere.
Format: Tabelle (Plan / Ist / Abweichung) + Fazit in 5 Sätzen.
Ton: Direkt, nüchtern, keine Beschönigung.
```

Das Beispiel enthält vereinfachte Plan- und Ist-Werte. Ein „effektiver Stundenlohn" lässt sich daraus ohne klare Definition von Materialmarge, Gemeinkosten, Steuer und Unternehmerlohn nicht seriös ableiten. Nutze die Tabelle, um Abweichungen zu finden, und lass die betriebswirtschaftliche Rechnung fachlich prüfen.
...
Bad 3,50 m x 4,00 m. Bodenfliesen: 14 qm (Feinsteinzeug 60x60).
Wandfliesen: 22 qm (Großformat 30x60). Duschbereich: bodengleich
mit Gefälle, 1,20 m x 0,90 m. Abdichtung nach DIN 18534.
Materialklasse: gehoben.
Rolle: Du bist ein erfahrener Handwerksmeister, der Angebote schreibt.
Aufgabe: Erstelle ein Angebot mit einzelnen Leistungspositionen.
Jede Position: Beschreibung, Menge, Einheit. KEINE Preise eintragen,
die ergänze ich selbst. Vermerke Sonderleistungen separat
(Abdichtung, Gefällestrich, Verfugung Dusche).
Format: Nummerierte Positionen. Sauber, druckfertig. Platz für
Einzelpreis und Gesamtpreis pro Position.
Ton: Professionell, klar, wie ein Innungsbetrieb.
```

Preise und Kalkulationsgrundlagen stammen aus deinem freigegebenen System, nicht aus einer Modellschätzung. Miss, ob der Textentwurf nach Prüfung tatsächlich Zeit spart.

**4. Kundenanfragen professionell beantworten**

Der Malermeister bekommt eine E-Mail: "Was kostet bei Ihnen das Streichen einer 3-Zimmer-Wohnung?" Ohne KI: 15 Minuten tippen. Mit KI:

```
Kontext: Ich bin Malermeister. Ein Interessent fragt per E-Mail
nach dem Preis für das Streichen einer 3-Zimmer-Wohnung.
Ich kann keinen Preis ohne Besichtigung nennen.
Rolle: Du bist mein Büroassistent.
Aufgabe: Schreibe eine freundliche Antwort. Erkläre, dass der
Preis von Fläche, Zustand und Farbwunsch abhängt. Biete einen
kostenlosen Besichtigungstermin an. Frage nach der Adresse
und zwei Terminvorschlägen.
Format: E-Mail, max. 80 Wörter.
Ton: Freundlich, professionell, wie ein Innungsbetrieb.
```
...
Arbeitsblatt zum Thema [THEMA] für [ZIELGRUPPE].
Rolle: Du bist ein erfahrener Didaktik-Experte.
Aufgabe: Erstelle ein Arbeitsblatt mit Reflexionsfragen,
einer praktischen Übung und Platz für Notizen.
Format: 1 Seite. Druckfreundlich. Klare Struktur.
Ton: Einfühlsam, motivierend, nicht belehrend.
```
...
Thema [THEMA]. Dauer: 8 Stunden (inkl. Pausen). Teilnehmer:
[ANZAHL], [ZIELGRUPPE]. Vorkenntnisse: [NIVEAU].
Rolle: Du bist ein erfahrener Didaktik-Experte für Erwachsenenbildung.
Aufgabe: Erstelle einen Seminarplan mit Zeitblöcken. Pro Block:
Thema, Methode (Vortrag/Gruppenarbeit/Einzelarbeit/Diskussion),
Material, Lernziel. Plane 2 Kaffeepausen und 1 Mittagspause ein.
Format: Tabelle mit: Uhrzeit, Thema, Methode, Material, Lernziel.
...
Zielgruppe: [ZIELGRUPPE]. Datum: [DATUM]. Preis: [BETRAG] EUR.
Rolle: Du bist ein Marketing-Texter für Coaching-Angebote.
Aufgabe: Schreibe einen Werbetext für [KANAL, Landing Page /
E-Mail / LinkedIn]. Der Text muss das Problem der Zielgruppe
ansprechen und den Workshop als Lösung positionieren.
Format: [LÄNGE]. Headline + 3 Absätze + CTA.
Ton: Einladend, empathisch, nicht reißerisch.
```
...
[STADTTEIL/LAGE]. Baujahr: [JAHR]. Besonderheiten: [BALKON/
GARTEN/PARKETT/AUFZUG/ETC.]. Kaufpreis: [PREIS] EUR.
Rolle: Du bist ein erfahrener Immobilien-Texter.
Aufgabe: Schreibe einen Exposé-Text in 3 Abschnitten: (1) Headline
und emotionaler Einstieg (Lebensgefühl, nicht Quadratmeter),
(2) Objektbeschreibung (Fakten + Highlights),
...
wie "lichtdurchflutet" oder "ideal gelegen."
```
...
"[FRAGE]." Die Antwort: [FAKT].
Rolle: Du bist mein Büroassistent.
Aufgabe: Schreibe eine freundliche, kurze Antwort. Beantworte
die Frage und lade zum nächsten Besichtigungstermin ein:
[DATUM/UHRZEIT].
Format: Max. 5 Sätze.
Ton: Professionell, einladend, nicht verkäuferisch.
```

**Tool-Tipp:** ChatGPT reicht. Für Exposé-Fotos: Canva mit KI-Bildbearbeitung (Helligkeit, Begradigung, virtuelle Möblierung). Für den Grundriss: Die meisten Portale haben eigene Tools.
...
mit [DIAGNOSE, z.B. Bandscheibenvorfall LWS].
Rolle: Du unterstützt einen qualifizierten medizinischen Redakteur.
Aufgabe: Erstelle einen Entwurf ausschließlich aus den unten
eingefügten, freigegebenen Fachquellen. Erfinde keine Diagnose,
Übung, Dosierung oder Warnschwelle. Markiere jede Aussage mit Quelle.
Inhalt: laienverständliche Erklärung, bereits fachlich freigegebene
Hinweise und klarer Verweis auf individuelle Beratung.
Format: 1 Seite, druckfreundlich. Einfache Sprache (Sprachniveau B1).
Nummerierte Übungen mit Wiederholungsangabe.
Ton: Empathisch, motivierend, nicht belehrend. Keine Fachbegriffe
ohne Erklärung.
```

**Wichtig:** Ein qualifizierter Behandler muss jedes Informationsblatt fachlich freigeben. Es ersetzt keine Diagnose oder individuelle Therapieempfehlung.
...
z.B. Sportler, Senioren, Büroangestellte mit Rückenproblemen].
Rolle: Du bist ein Marketing-Berater für Gesundheitsberufe.
Aufgabe: Schreibe 4 Social-Media-Posts für Instagram. Themen:
(1) Eine häufige Patientenfrage beantworten, (2) Eine Übung zeigen
(Textbeschreibung zum Nachfilmen), (3) Praxis-Einblick (Teamfoto,
neues Gerät), (4) Gesundheitstipp der Woche.
Format: Je 80-120 Wörter. Hook in der ersten Zeile. 3 Hashtags.
Ton: Kompetent, nahbar, nicht klinisch.
```
...
> | Messgröße | Dein Wert |
> |---|---|
> | Bearbeitungszeit inklusive Prüfung vorher | ___ |
> | Bearbeitungszeit inklusive Prüfung im Pilot | ___ |
