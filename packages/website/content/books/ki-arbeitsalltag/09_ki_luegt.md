...
Einziges Problem: Diesen Paragraphen gibt es nicht. Erfunden. Überzeugend erfunden.
...
Richter Kevin Castel überprüft. Keine der sechs Entscheidungen existiert. Null. Die Richternamen sind real, aber sie haben diese Fälle nie verhandelt. Die Aktenzeichen klingen plausibel, sind erfunden. Die Zitate lesen sich überzeugend, aus Urteilen, die es nie gab.
...
Warum es passiert ist: ChatGPT berechnet das wahrscheinlichste nächste Wort. Für juristische Zitate heißt das: Es generiert Text, der wie ein echtes Urteil klingt, weil echte Urteile genau so klingen. Es hat kein Konzept von "wahr." Es hat Wahrscheinlichkeiten.
...
Wenn du fragst "Wer hat die Relativitätstheorie entwickelt?", ist "Albert Einstein" das wahrscheinlichste Token. Korrekt.

Wenn du fragst "Welche Studie belegt, dass 73 % der deutschen Mittelständler KI nutzen?", generiert das Modell einen Autorennamen, ein Institut, ein Erscheinungsjahr. Klingt echt. Muss nicht existieren.
...
In allen drei Fällen hat die KI genau so funktioniert, wie sie entworfen wurde. Der Schaden entstand, weil ein Mensch das Ergebnis ohne Prüfung übernommen hat.

## Drei Arten, wie KI lügt

Halluzinationen sind nicht alle gleich. Drei Muster, die dir im Alltag begegnen:

**1. Erfundene Rechtsquellen.** Paragraphen, Urteile, Gerichtsentscheidungen, die plausibel formatiert sind, aber nicht existieren. Kommt bei allen großen Modellen vor. Besonders häufig bei Nischen-Themen (deutsches Arbeitsrecht, spezifische BGB-Stellen, regulatorische Details).
...
Das ist keine böse Absicht. Es ist Statistik: Wenn in Millionen Texten mehr Chefärzte männlich beschrieben wurden, bleibt das die wahrscheinlichere Fortsetzung. Deine Aufgabe: Bias erkennen und gegensteuern. Entweder im Prompt („neutrale Formulierung, keine Pronomen-Annahme") oder in der Nachbearbeitung.
...
Das ist keine Schwäche, die man repariert. Es ist der Preis für ein System, das alles schreiben kann, einschließlich Dinge, die nicht stimmen.
