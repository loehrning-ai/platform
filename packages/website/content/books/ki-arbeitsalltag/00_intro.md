> **Hinweis:** Dieses Buch begleitet den [KI-Führerschein](/ki-fuehrerschein) auf dieser Plattform. Es ist für alle gedacht, die KI im Arbeitsalltag nutzen wollen (mit oder ohne technische Vorkenntnisse). Empfohlener Lesepfad: Kapitel 1-4 für den Einstieg, dann Themen nach Bedarf.
...
| Phase | Kurs | Buch |
|-------|------|------|
| **1. Lernen** | Interaktive Lektionen (5-10 min pro Lektion) | *nicht nutzen* |
| **2. Vertiefen** | Quiz und Reflexions-Fragen (5-10 min) | **Lies das entsprechende Kapitel** |
| **3. Anwenden** | Praktische Übungen (15-30 min) | Checklisten nachschlagen |
| **4. Referenzieren** | "Warte, wie ging das noch mal?" | **Schlag das Stichwort im Anhang nach** |

## Die Struktur

Das Buch folgt den fünf Kurs-Blöcken, ergänzt um Einleitung und Anhang:

- **Block 1: Entdeckung** → Kapitel 01-02
- **Block 2: Datenschutz** → Kapitel 03-05
- **Block 3: Anwendung** → Kapitel 06-08
- **Block 4: Verifikation** → Kapitel 09-10
...
Nach dem Kurs und diesem Buch:

- [ ] Ich verstehe, wo KI in meinem Job anwendbar ist
- [ ] Ich kenne die Risiken und weiß, wie ich sie minimiere
- [ ] Ich habe ein Prompt-System, das für mich funktioniert
