...
>
> vielen Dank für Ihre Nachricht, und entschuldigen Sie bitte die Verzögerung bei Ihrer Lieferung. Dass Ihre Komponenten acht Werktage zu spät kommen, ist für Ihre Planung ärgerlich, das verstehe ich.
>
> Ich habe den Vorgang geprüft. Ihre Sendung ist seit gestern in der Endkontrolle und verlässt unser Werk spätestens am Mittwoch. Eine Sendungsnummer schicke ich Ihnen, sobald sie vorliegt. Als kleine Wiedergutmachung für die Unannehmlichkeiten lasse ich Ihnen einen Rabatt von 5 Prozent auf diese Bestellung gutschreiben.
>
> Für Rückfragen erreichen Sie mich jederzeit direkt.
>
...
**Variante A, Copilot in Teams.** Automatische Zusammenfassung mit Aufgaben und Schlüsselmomenten. Drei Minuten nach dem Meeting fertig. Typische Fehler: Sprecher verwechselt, beiläufige Bemerkungen als Entscheidungen interpretiert. Deshalb: immer gegenlesen.

**Variante B, Manueller Prompt:**
...
Nachher: Er diktiert seine Notizen ins Handy, schickt sie durch einen Prompt.
...
### Profil D: Die ruhige Antwort vom Service

Sandra arbeitet im Kundenservice, technischer Großhandel. Eine Mail kommt rein, in Großbuchstaben: Bestellung falsch geliefert, dritte Beschwerde, der Kunde droht mit Kündigung. Sandra ist genervt, der Ton steckt an. Ihr erster Entwurf ist defensiv.

Vorher: Sie schreibt zurück, klingt patzig, der Kunde eskaliert weiter.

Nachher: Sie lässt die KI den Ton glätten, bevor sie tippt.

> **Prompt-Vorlage:** Rolle: Du bist Kundenservice-Mitarbeiter bei einem technischen Großhändler. Kontext: Kunde hat dreimal die falsche Lieferung erhalten, ist wütend, droht mit Kündigung. Aufgabe: Schreibe eine deeskalierende Antwort. Nimm die Verärgerung ernst, übernimm Verantwortung für den Fehler, nenne einen konkreten nächsten Schritt. Ton: ruhig, verbindlich, keine Floskeln, keine Schuldzuweisung an Kollegen oder Versand. Format: maximal 120 Wörter. Mach keine Zusagen zu Erstattungen oder Rabatten ohne meinen Vermerk.

Ergebnis: eine ruhige, klare Antwort. Der Kunde fühlt sich gehört, der Ball liegt wieder bei Sandra, nicht in der Eskalation. Sie prüft: Keine unautorisierten Zusagen? Stimmt der versprochene Schritt? Dann erst abschicken.

> **Tipp:** Bei wütenden Mails ist die KI nicht klüger als du, aber sie ist nicht sauer. Genau das ist der Wert. Sie schreibt den Ton, den du im Affekt nicht triffst.

## Die Rechnung

| Aufgabe | Ohne KI | Mit KI | Ersparnis |
|---------|---------|--------|-----------|
| E-Mail (Reklamation) | 12 Min. | 4 Min. | 8 Min. |
| Meeting-Protokoll | 25 Min. | 5 Min. | 20 Min. |
| Wochenbericht | 45 Min. | 10 Min. | 35 Min. |

63 Minuten pro Durchlauf. Bei typischen Frequenzen, fünf Mails, drei Meetings, ein Bericht pro Woche, sind das rund **2,5 Stunden pro Woche**. Auf 46 Arbeitswochen gerechnet: **115 Stunden im Jahr.**
...
> **Jetzt bist du dran:** Nimm deine letzte E-Mail, die länger als zehn Minuten gedauert hat. Schreib einen Prompt dafür nach KRAFT-Schema. Miss die Zeit. Der Unterschied wird dich überraschen.
