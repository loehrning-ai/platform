...
**Result:** a prioritized use case with a documented baseline.
...
**Result:** reproducible test data and a documented decision.
...
No fixed percentage rule decides this question.

| Criterion | Existing service | Configurable platform | In-house development |
|---|---|---|---|
| Differentiation | low to medium | medium | potentially high |
| Operational burden | partly with the provider | shared | largely internal |
...
3. security evidence, identity, and access
4. system and model updates
5. logs, monitoring, and incident cooperation
6. export, deletion, and exit
7. cost model at a realistic volume
8. domain approval and support

## Derive metrics from the use case
