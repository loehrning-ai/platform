...
const result = spawnSync(
  ...
  [wrapper, process.execPath, "-e", probe],
  {
    ...
    env: {
      ...
      VERCEL_ANALYTICS_API_TOKEN: "sentinel-vercel-analytics-token",
      VERCEL_ANALYTICS_TEAM_ID: "sentinel-vercel-team",
      VERCEL_EVENT_ASSESSMENT_AT: "sentinel-event-assessment-date",
      VERCEL_PROJECT_ID: "sentinel-vercel-project",
      LOEHRNING_ADMIN_USER_ID: "sentinel-admin-identity",
      E2E_AUTH_LIVE: "1",
